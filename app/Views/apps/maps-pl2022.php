    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
        ...
        <script>
            ...
            info.update = function(props) {
                this._div.innerHTML = '<h4><b>PL KHTDK Fakultas Kehutanan UGM<br>Tahun 2022</b></h4>' +
                    (props ?
                        'Penutupan Lahan : <b>' + props.PL +
                        '</b> <br> Luas : <b>' + props.Luas_Ha + ' Ha' :
                        '</b>Layangkan cursor pada kawasan');
            };
            ...
            function getColor(d) {
                return d == "Jagung" ? '#e3ea1f' :
                    d == "Jalan" ? '#94948c' :
                    d == "Jati" ? '#b8f37e' :
                    d == "Jati Campur Semak" ? '#76c12d' :
                    d == "Jati Plus Perhutani" ? '#81610b' :
                    d == "Mahoni" ? '#458308' :
                    d == "Makam" ? '#0fb71e' :
                    d == "Permukiman" ? '#b70f8e' :
                    d == "Sawah" ? '#eabb84' :
                    d == "Semak" ? '#c9ae67' :
                    d == "Sungai" ? '#810b32' : '#e31a1c';
            }
            ...
            function style(feature) {
                return {
                    ...
                    dashArray: '3',
                    fillOpacity: 0.4,
                    fillColor: getColor(feature.properties.PL)
                };
            }
            ...
            legend.onAdd = function(map) {
                ...
                var grades = ['Jagung', 'Jalan', 'Jati', 'Jati Campur Semak', 'Jati Plus Perhutani', 'Mahoni', 'Makam', 'Permukiman', 'Sawah', 'Semak', 'Sungai', 'Tebu'];
                var labels = [];
                var from, to;
